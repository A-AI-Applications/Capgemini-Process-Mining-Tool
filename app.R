...
# Title: Capgemini Process Mining Tool
# Description: A Shiny App to allows process mining of event logs in R
# Date: 2022-11-04
# Contact: noel.dempsey@capgemini.com
...
sidebar <- dashboardSidebar(
  ...
  helpText(
    p(tags$b("About:"), "This is a demo process mining tool intended for client demonstrations and simple event log exploration."),
    p(tags$b("Contact:"), "noel.dempsey@capgemini.com"))
)

# Body
body <- dashboardBody(
  tags$head(includeCSS("www/capgemini.css")),
...
# Overall UI
ui <- dashboardPage(
  preloader = list(html = tagList(spin_1(), "Loading..."), color = CAPGEMINI_COLOR),
  title = "",
  dark = NULL, 
